...
from app.db.db_connection import DATABASE_URL
...
async def run_migrations_online() -> None:
    ...
    """
    engine = create_async_engine(config.get_main_option("sqlalchemy.url"))  # type: ignore[arg-type]

    def do_migrations(connection_: Connection) -> None:
        context.configure(
